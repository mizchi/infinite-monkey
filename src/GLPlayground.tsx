...
function runGPGPU(
  ...
  const outputVao = createVAO(gl, program, outputBuffer, inputs, STRIDE);

  gl.bindVertexArray(inputVao);
  gl.bindBufferBase(gl.TRANSFORM_FEEDBACK_BUFFER, 0, outputVao);
  gl.beginTransformFeedback(gl.POINTS);
  gl.drawArrays(gl.POINTS, 0, INPUT_NUM);
